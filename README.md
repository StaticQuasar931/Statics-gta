...
Neon Grandline is a browser-first, third-person crime sandbox inspired by blockbuster open-world series. Every system—world generation, rendering, AI, economy, UI—is hand-written in vanilla HTML/CSS/JS plus a lean Three.js renderer so the experience launches instantly on GitHub Pages with zero build tooling.

## Highlights

- **Custom neon renderer** – A lean Three.js pipeline paints the city with emissive roads, layered shadows, and depth-aware meshes textured by bespoke SVG art for every building, vehicle, and character. Screen-to-world raycasts keep aiming precise.
...
assets/
  ...
  scripts/
    ...
    engine/
      ...
      renderer.js              # Three.js WebGL renderer with chase camera and raycasts
    gameplay/
...
- Works in the latest Chrome, Edge, Firefox, and Safari releases with WebGL/Three.js acceleration.
